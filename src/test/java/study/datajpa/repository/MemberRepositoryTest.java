...
class MemberRepositoryTest {
    ...
    void returnType() {
        ...
        List<Member> aaa1 = memberRepository.findListByUsername("ㄴㅁㅇㅁㄴㅇㅁㄴㅇ");
        System.out.println("aaa1 = " + aaa1);
        Member aaa2 = memberRepository.findMemberByUsername("asdasdasdasd");
    ...
    void queryByExample() {
        ...
        // when
        // Probe
        Member member = new Member("m1"); // age가 primitive 타입이라서 null이 없기 때문에 쿼리에 0 값이 나간다. (ExampleMatcher가 없다면)
        Team team = new Team("teamA");
        member.setTeam(team);
